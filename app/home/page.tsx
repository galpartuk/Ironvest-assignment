...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 page-transition">
      <nav className="bg-white shadow-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-14 sm:h-16 items-center">
            ...
            <Button variant="outline" onClick={handleLogout} size="sm" className="text-xs sm:text-base">
              Logout
            </Button>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 p-3 sm:p-4 bg-slate-50 rounded-lg">
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs text-slate-500 font-medium">Biometric Status</p>
